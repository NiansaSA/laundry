...
// Route::get('/tampil_detail', 'DetailtransaksiController@index')->middleware('jwt.verify');
// Route::get('/index_detail/{tgl_transaksi}/{tgl_selesai}', 'DetailtransaksiController@index')->middleware('jwt.verify');
